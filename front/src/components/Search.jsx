...
import { addFavorites, deleteFavorites } from "../redux/slices/favoriteSlice";
        ...
        dispatch(
          addFavorite({
            ...
            data: {
              ...
              heritagename: heritage.ccbamnm1,
              heritageimageurl: heritage.imageurl,
              location: heritage.ccbalcad,
